...
UPDATE
  producto
set
  descripcion = 'Con nuestras deliciosas y únicas salsas de guabos.'
where
  id_producto = 5
  AND id_producto = 6
  AND id_producto = 7
...
VALUES
  (
    ...
    'C:/xampp/htdocs/Front_Guabos/Front_Guabos/Imagenes/La_Guabos.jpg',
    70.00,
    'Hamburguesas'
  ),
  (
    ...
    'C:/xampp/htdocs/Front_Guabos/Front_Guabos/Imagenes/Dark_Bacon.jpg',
    105.00,
    'Hamburguesas'
  ),
  (
    ...
    'C:/xampp/htdocs/Front_Guabos/Front_Guabos/Imagenes/Barbie-Q.jpg',
    90.00,
    'Hamburguesas'
  ),
  (
    ...
    'C:/xampp/htdocs/Front_Guabos/Front_Guabos/Imagenes/Jana_Burguer.jpg',
    115.00,
    'Hamburguesas'
  ),
  -- ----------------------------------------------------------------------
  (
    ...
    'C:/xampp/htdocs/Front_Guabos/Front_Guabos/Imagenes/boneless.jpg',
    99.00,
    'Boneless'
  ),
  (
  ...
  (
    'Alitas 8 PZ',
    'Con nuestras deliciosas y únicas salsas de guabos.',
    'C:/xampp/htdocs/Front_Guabos/Front_Guabos/Imagenes/alitas.jpg',
    99.00,
    'Alitas'
  ),
  (
  ...
  (
    ...
    'C:/xampp/htdocs/Front_Guabos/Front_Guabos/Imagenes/fries.jpg',
    45.00,
    'Entradas'
  ),
  (
    ...
    'C:/xampp/htdocs/Front_Guabos/Front_Guabos/Imagenes/guabosfries.jpg',
    75.00,
    'Entradas'
  ),
  (
    ...
    'C:/xampp/htdocs/Front_Guabos/Front_Guabos/Imagenes/guabosfries_tenders.jpg',
    120.00,
    'Entradas'
  ),
  (
    ...
    'C:/xampp/htdocs/Front_Guabos/Front_Guabos/Imagenes/guabits.jpg',
    65.00,
    'Entradas'
  );
