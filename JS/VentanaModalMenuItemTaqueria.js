// const openModal_P1 = document.querySelector('#item1');
// const modal_P1 = document.querySelector('#modalItem1');
// const closeModal_P1 = document.querySelector('#closeItem1');

// openModal_P1.addEventListener('click', (e)=>{
//     e.preventDefault();
//     modal_P1.classList.add('modal--show');
// });

// closeModal_P1.addEventListener('click', (e)=>{
//     e.preventDefault();
//     modal_P1.classList.remove('modal--show');
// });

// const openModal_P2 = document.querySelector('#item2');
// const modal_P2 = document.querySelector('#modalItem2');
// const closeModal_P2 = document.querySelector('#closeItem2');

// openModal_P2.addEventListener('click', (e)=>{
//     e.preventDefault();
//     modal_P2.classList.add('modal--show');
// });

// closeModal_P2.addEventListener('click', (e)=>{
//     e.preventDefault();
//     modal_P2.classList.remove('modal--show');
// });

//----------------------------------------------------------------------------------------------------------------
// const openModal_P2 = document.querySelector('.contenedor_producto');
// const modal_P2 = document.querySelector('.modal');
// const closeModal_P2 = document.querySelector('.modal__close');
