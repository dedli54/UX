...
//     const papas = modalActual.querySelector('input[name="papas"]:checked')
//       .parentElement.innerText;
//     const bebida = modalActual.querySelector('input[name="bebida"]:checked')
//       .parentElement.innerText;
//     const cantidad = parseInt(
//       modalActual.querySelector("#cantidad").textContent
//     );
